        ...
        <div class="grid lg:grid-cols-2 gap-12">
            ...
            <div>
                ...
                <div class="bg-white rounded-2xl p-8 mb-6 border border-gray-200">
                    <img src="{{ asset('images/products/detail-product/nike-air-force1-front.png') }}" alt="Nike Dunk Low" class="w-auto aspect-square object-contain" id="mainImage">
                </div>

                <!-- Thumbnail Gallery -->
                <div class="grid grid-cols-4 gap-4">
                    <button class="thumbnail-btn bg-white rounded-lg p-4 border-2 border-blue-950 hover:border-blue-900 transition" 
                            data-image="{{ asset('images/products/detail-product/nike-air-force1-front.png') }}">
                        <img src="{{ asset('images/products/detail-product/nike-air-force1-front.png') }}" alt="View 1" class="w-full aspect-square object-contain">
                    </button>
                    <button class="thumbnail-btn bg-white rounded-lg p-4 border-2 border-gray-200 hover:border-blue-950 transition" 
                            data-image="{{ asset('images/products/detail-product/nike-air-force1-side.png') }}">
                        <img src="{{ asset('images/products/detail-product/nike-air-force1-side.png') }}" alt="View 2" class="w-full aspect-square object-contain">
                    </button>
                    <button class="thumbnail-btn bg-white rounded-lg p-4 border-2 border-gray-200 hover:border-blue-950 transition" 
                            data-image="{{ asset('images/products/detail-product/nike-air-force1-back.png') }}">
                        <img src="{{ asset('images/products/detail-product/nike-air-force1-back.png') }}" alt="View 3" class="w-full aspect-square object-contain">
                    </button>
                    <button class="thumbnail-btn bg-white rounded-lg p-4 border-2 border-gray-200 hover:border-blue-950 transition" 
                            data-image="{{ asset('images/products/detail-product/nike-air-force1-button.png') }}">
                        <img src="{{ asset('images/products/detail-product/nike-air-force1-button.png') }}" alt="View 4" class="w-full aspect-square object-contain">
                    </button>
                </div>
            </div>
            ...
            <div>
                ...
                <div class="flex items-center gap-3 mb-4">
                    ...
                    <span class="bg-red-600 text-white px-3 py-1 rounded-full text-xs font-bold">HEMAT Rp.200.000</span>
                </div>

                <!-- Product Name -->
                <h1 class="text-4xl font-extrabold text-gray-900 mb-2">Nike Air Force 1</h1>
                ...
                <div class="mb-6">
                    <div class="flex items-baseline gap-3">
                        <span class="text-4xl font-bold text-gray-900">Rp. 1.600.000</span>
                        <span class="text-2xl text-gray-400 line-through">Rp. 1.800.000</span>
                    </div>
                    <p class="text-green-600 font-semibold mt-1">3,9% off</p>
                </div>
