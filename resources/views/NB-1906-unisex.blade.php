...
<head>
    ...
    <title>New Balance Unisex - MySneakers</title>
        ...
        <div class="grid lg:grid-cols-2 gap-12">
            ...
            <div>
                ...
                <div class="bg-white rounded-2xl p-8 mb-6 border border-gray-200">
                    <img src="{{ asset('images/products/detail-product/1906-side.webp') }}" alt="Nike Dunk Low" class="w-auto aspect-square object-contain" id="mainImage">
                </div>

                <!-- Thumbnail Gallery -->
                <div class="grid grid-cols-4 gap-4">
                    <button class="thumbnail-btn bg-white rounded-lg p-4 border-2 border-blue-950 hover:border-blue-900 transition" 
                            data-image="{{ asset('images/products/detail-product/1906-side.webp') }}">
                        <img src="{{ asset('images/products/detail-product/1906-side.webp') }}" alt="View 1" class="w-full aspect-square object-contain">
                    </button>
                    <button class="thumbnail-btn bg-white rounded-lg p-4 border-2 border-gray-200 hover:border-blue-950 transition" 
                            data-image="{{ asset('images/products/detail-product/1906-top.webp') }}">
                        <img src="{{ asset('images/products/detail-product/1906-top.webp') }}" alt="View 2" class="w-full aspect-square object-contain">
                    </button>
                    <button class="thumbnail-btn bg-white rounded-lg p-4 border-2 border-gray-200 hover:border-blue-950 transition" 
                            data-image="{{ asset('images/products/detail-product/1906-back.webp') }}">
                        <img src="{{ asset('images/products/detail-product/1906-back.webp') }}" alt="View 3" class="w-full aspect-square object-contain">
                    </button>
                    <button class="thumbnail-btn bg-white rounded-lg p-4 border-2 border-gray-200 hover:border-blue-950 transition" 
                            data-image="{{ asset('images/products/detail-product/1906-sol.webp') }}">
                        <img src="{{ asset('images/products/detail-product/1906-sol.webp') }}" alt="View 4" class="w-full aspect-square object-contain">
                    </button>
                </div>
            </div>
            ...
            <div>
                ...
                <!-- Product Name -->
                <h1 class="text-4xl font-extrabold text-gray-900 mb-2">New Balance 1906 Unisex</h1>
                <p class="text-gray-600 mb-1">Unisex Sport Wear</p>
                <a href="#" class="text-blue-950 font-semibold text-sm hover:underline mb-6 inline-block">Explore New Balance</a>

                <!-- Price -->
                <div class="mb-6">
                    <div class="flex items-baseline gap-3">
                        <span class="text-4xl font-bold text-gray-900">Rp. 2.599.000</span>
                    </div>
                </div>
