        ...
        <div class="grid lg:grid-cols-2 gap-12">
            ...
            <div>
                ...
                <div class="bg-white rounded-2xl p-8 mb-6 border border-gray-200">
                    <img src="{{ asset('images/products/detail-product/samba-og-woman-side.webp') }}" alt="Nike Dunk Low" class="w-auto aspect-square object-contain" id="mainImage">
                </div>

                <!-- Thumbnail Gallery -->
                <div class="grid grid-cols-4 gap-4">
                    <button class="thumbnail-btn bg-white rounded-lg p-4 border-2 border-blue-950 hover:border-blue-900 transition" 
                            data-image="{{ asset('images/products/detail-product/samba-og-woman-side.webp') }}">
                        <img src="{{ asset('images/products/detail-product/samba-og-woman-side.webp') }}" alt="View 1" class="w-full aspect-square object-contain">
                    </button>
                    <button class="thumbnail-btn bg-white rounded-lg p-4 border-2 border-gray-200 hover:border-blue-950 transition" 
                            data-image="{{ asset('images/products/detail-product/samba-og-woman-front.webp') }}">
                        <img src="{{ asset('images/products/detail-product/samba-og-woman-front.webp') }}" alt="View 2" class="w-full aspect-square object-contain">
                    </button>
                    <button class="thumbnail-btn bg-white rounded-lg p-4 border-2 border-gray-200 hover:border-blue-950 transition" 
                            data-image="{{ asset('images/products/detail-product/samba-og-woman-top.webp') }}">
                        <img src="{{ asset('images/products/detail-product/samba-og-woman-top.webp') }}" alt="View 3" class="w-full aspect-square object-contain">
                    </button>
                    <button class="thumbnail-btn bg-white rounded-lg p-4 border-2 border-gray-200 hover:border-blue-950 transition" 
                            data-image="{{ asset('images/products/detail-product/samba') }}">
            ...
            <div>
                ...
                <!-- Product Name -->
                <h1 class="text-4xl font-extrabold text-gray-900 mb-2">Adidas Samba OG Woman Shoes</h1>
                <p class="text-gray-600 mb-1">Woman Shoes</p>
                <a href="#" class="text-blue-950 font-semibold text-sm hover:underline mb-6 inline-block">Explore Adidas</a>

                <!-- Price -->
                <div class="mb-6">
                    <div class="flex items-baseline gap-3">
                        <span class="text-4xl font-bold text-gray-900">Rp. 2.00.000</span>
                    </div>
                </div>
