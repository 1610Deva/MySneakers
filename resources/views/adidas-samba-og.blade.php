...
<body class="bg-gray-50" style="font-family: 'DM Sans', sans-serif;" x-data="shoppingCart()">
    ...
    <div class="container mx-auto px-6 py-12">
        <div class="flex items-center gap-2 text-sm text-gray-600 mb-2">
                ...
                <span>/</span>
                <span class="text-gray-900 font-medium">Adidas Samba OG Black</span>
        </div>
        ...
        <div class="grid lg:grid-cols-2 gap-12">
            ...
            <div>
                ...
                <!-- Product Name -->
                <h1 class="text-4xl font-extrabold text-gray-900 mb-2">Adidas Samba OG - Black</h1>
                <p class="text-gray-600 mb-1">Boys' Grade School, Versatile Sneakers</p>
                ...
                @click="addToCart({ 
                    ...
                    image: '{{ asset('images/products/adidas-samba-og.webp') }}' 
                })"
               ...
               <form action="{{ route('checkout.process') }}" method="POST" class="mt-4">
                    ...
                    <input type="hidden" name="product_image" value="{{ asset('images/products/adidas-samba-og.webp') }}">
