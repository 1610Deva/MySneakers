...
<body class="bg-slate-50" style="font-family: 'DM Sans', sans-serif;">
    ...
    <div class="container mx-auto px-6 py-12">
        <div class="flex items-center gap-2 text-sm text-gray-600 mb-2">
                <a href="#" class="hover:text-blue-950">Adidas</a>
                <span>/</span>
                <a href="#" class="hover:text-blue-950">Men's</a>
                <span>/</span>
                <span class="text-gray-900 font-medium">Adidas Dunk Low</span>
        </div>
        ...
        <div class="grid lg:grid-cols-2 gap-12">
            ...
            <div>
                ...
                <!-- Wishlist Button -->
                <button class="w-full border-2 border-gray-300 text-gray-900 py-4 rounded-lg font-bold text-lg hover:border-blue-950 hover:bg-slate-50 transition-all flex items-center justify-center gap-2">
                ...
                <!-- Shipping Info -->
                <div class="mt-8 bg-slate-50 rounded-lg p-6 border border-gray-200">
                    <div class="flex items-start gap-4 mb-4">
                        <svg class="w-6 h-6 text-green-600 shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path>
                        </svg>
                        <div>
                            <h4 class="font-bold text-gray-900 mb-1">Free standard shipping for FLX Rewards members</h4>
                            <p class="text-sm text-gray-600"><a href="#" class="text-blue-950 font-semibold underline">Sign in</a> / <a href="#" class="text-blue-950 font-semibold underline">Join for free</a></p>
                        </div>
                    </div>
                    <div class="flex items-start gap-4">
                        <svg class="w-6 h-6 text-blue-950 shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                        </svg>
                        <div>
                            <h4 class="font-bold text-gray-900 mb-1">Ship to store</h4>
                            <p class="text-sm text-gray-600">Collect your order at your preferred store</p>
                            <a href="#" class="text-blue-950 font-semibold text-sm underline">Find stores near you</a>
                        </div>
                    </div>
                </div>
            </div>
